<?php
    ...
    //require get_template_directory() . '/Team-master/TeamProfiles.php';    

    //require get_template_directory() . '/inc/proyecto/proyecto.php';    
...
//require get_template_directory() . '/inc/plugins/apus-framework/apus-framework.php';
//require get_template_directory() . '/inc/tutorial.php';
